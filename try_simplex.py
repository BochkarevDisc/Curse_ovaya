...
field2=Simplex.mult_Simplex_fast(x,y,p,grad)
aa1=np.array(aa0)
...
axs[2].imshow(field2, origin="lower", cmap='gray')
axs[2].set_title("Simplex x1")
...
res1=Simplex.SimplexNoise([3.63,4],p,grad)
res2=aa0.noise2d(3.63,4)
